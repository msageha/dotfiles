...
- Data Models: Use pydantic BaseModel (not dataclasses) for strict typing and validation, and StrEnum for enums. Write a description and a default value for every Field.
